...
| Submit external forms safely or automate CRM operations | [api/crm-operations.md](api/crm-operations.md) |
| Install first-party campaigns or approved SMTP email | [api/campaigns.md](api/campaigns.md) |
